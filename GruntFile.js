	...
	(
		{ 
			...
			compileAndCopy: { //child of parent task.
				...
				files: {
					/*destination*/'html_dev/style.css' : 'sass/style.scss' //source. The task Sass/CompileAndCopy looks at the style.scss and compiles/outputs that to style.css
					}
				}
			},
	            ...
	            { 
	                ...
	                [
	                    { 
		                    ...
		                    dest: 'C:/wamp64/www/flexbox' //any output I make is put in here
            ...
            */
            {
				css: //child task
				{
					files: 'sass/style.scss', //watch this file
